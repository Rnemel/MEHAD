...
class SeizeIT2Dataset(Dataset):
    def __init__(self, file_paths, transform=None):
        ...
        self.open_files = {} # Simple Cache: {path: data}
    ...
    def __getitem__(self, idx):
        ...
        if self.last_accessed_path != str_path:
            ...
            try:
                # FULL LOAD TO RAM (FASTEST for Colab too)
...
def train_colab_model(data_dir):
    ...
    if ram_gb > 25 and cores >= 4:
        ...
        print(f"Colab Pro+ detected: using {workers} workers for data loading.")
    else:
        workers = 0
        print(f"Standard instance: using {workers} workers (Safe Mode).")
    
    if workers > 0:
        workers = 0
        print("Using 0 workers for NPZ stability.")
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            patience += 1
            if patience >= 5: # Increased patience for final run
